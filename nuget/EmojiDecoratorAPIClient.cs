...
namespace APIVerve.API.EmojiDecorator
{
    ...
    /// <summary>
    /// Client for the EmojiDecorator API
    /// </summary>
    public class EmojiDecoratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/emojidecorator";
        ...
        public EmojiDecoratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public EmojiDecoratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public EmojiDecoratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, EmojiDecoratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(EmojiDecoratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(EmojiDecoratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(EmojiDecoratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(EmojiDecoratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(EmojiDecoratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(EmojiDecoratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(EmojiDecoratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(EmojiDecoratorQueryOptions options)
        {
