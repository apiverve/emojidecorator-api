...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/emojidecorator](https://docs.apiverve.com/ref/emojidecorator)

---

## Use Cases

Common use cases for the Emoji Decorator API:
