# Emoji Decorator API - Examples

This folder contains example code for using the Emoji Decorator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/emojidecorator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/emojidecorator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/emojidecorator](https://docs.apiverve.com/ref/emojidecorator)
