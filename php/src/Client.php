...
namespace APIVerve\Emojidecorator;
...
/**
 * Client for the Emoji Decorator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/emojidecorator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/emojidecorator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\EmojidecoratorClient] {$message}\n";
        }
    }
}
