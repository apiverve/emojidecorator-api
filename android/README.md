...
```gradle
dependencies {
    implementation 'com.github.apiverve:emojidecorator-api:1.1.12'
}
```
...
```java
import com.apiverve.emojidecorator.EmojiDecoratorAPIClient;
import com.apiverve.emojidecorator.APIResponse;
import com.apiverve.emojidecorator.APIException;

// Initialize the client
EmojiDecoratorAPIClient client = new EmojiDecoratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/emojidecorator](https://docs.apiverve.com/ref/emojidecorator)
...
- **Documentation:** [https://docs.apiverve.com/ref/emojidecorator](https://docs.apiverve.com/ref/emojidecorator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/emojidecorator-api/issues)
